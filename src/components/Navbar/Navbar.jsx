...
const notifContext = useUserNotifications() || {};
...
const getMessage = (n) => {
    // If 'message' exists, use it; otherwise combine title + description
    return n.message || `${n.title || ""}: ${n.description || ""}`;
};

// Helper to get read status safely
const isReadStatus = (n) => n.isRead ?? n.read ?? false;
                  ...
                  {notifications.length > 0 ? (
                    <>
                      {visibleNotifications.map((n) => {
                        ...
                        const isRead = isReadStatus(n);
                        const isExpanded = expandedIds.includes(n.id);

                        return (
                          <li
                            key={n.id}
                            className={`dropdown-item small d-flex justify-content-between align-items-start ${
                              !isRead ? "bg-light fw-bold" : ""
                            }`}
              ...
              <div className="d-none d-md-flex align-items-center gap-4">
                ...
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <Link className="dropdown-item" to="/account/contact">
                        <i className="bi bi-person-lines-fill"></i> Contact
                      </Link>
                    </li>
                  </ul>
                ...
                <Link
                  to="/cart"
                  className="text-white text-decoration-none position-relative me-3"
                >
