...
const CheckoutForm = ({
  ...
  const savedAddress = user
    ? JSON.parse(localStorage.getItem(`address_${user.id}`))
    : null;
  ...
  // --- Helper: format price according to currency ---
  ...
  const totalPrice = checkoutItems.reduce((sum, p) => {
    ...
    <form id="checkoutForm" onSubmit={handleSubmit}>
      ...
      <div className="review-product border rounded p-3 m-2">
              ...
              >
                <div className="d-flex flex-column align-items-center text-center">
                  ...
                  <div className="d-flex align-items-center justify-content-center mb-1">
                    ...
                    {p.sizes?.length > 0 ? (
                      <select
                        ...
                        value={p.selectedSize || "Free Size"}
                  ...
                  <p className="fw-bold mb-0">
                    {formatPrice(sizePrice * p.quantity, currency)}
                  </p>
                </div>
              </div>
            );
        ...
        <div className="d-flex justify-content-between border-top pt-2 mt-3">
          ...
          <strong>{formatPrice(totalPrice, checkoutItems[0]?.currency)}</strong>
        </div>
      </div>
